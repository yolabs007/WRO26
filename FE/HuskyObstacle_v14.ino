// ============================================================
// WRO FE 2026 — OBSTACLE — STEP 4 v14 : FULL RUN (3 laps, no parking)
...
//
// Log line (CSV):
//   t_ms,mm,state,F,L,R,hdg,tgt,h_err,servo,col,x,x_frac,y,bottom,h,w,blocks,carLat,turn,meas,rej
//
...
void setup() {
  ...
  logLine(String("STEP 4 v14 FULL RUN ready (MOTOR_ON=") + MOTOR_ON + ", SWERVE_MODE=" + SWERVE_MODE + ", GATE=" + GATE_ON + ", BACKUP=" + BACKUP_ON + ", UNSTICK=" + UNSTICK_ON + "). Press START."); logFlush();
